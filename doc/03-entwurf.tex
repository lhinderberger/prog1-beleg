...
von Glade gezeigt. Selbst das recht einfache Design des Willkommensbildschirms hat vergleichsweise viel Zeit in Anspruch
genommen, um mit Glade umgesetzt zu werden.
...
lediglich Verwirrung stiftet}, sowie mangelndes Feedback auf eine Vielzahl an Benutzereingaben, mangelnde Robustheit und
Fehlertoleranz der Oberfläche und nicht zuletzt mangelnde Flexibilität\footnote{Beispielsweise ist ein Verschieben von
Buttons zwischen unterschiedlichen Layouts nicht -- oder zumindest nicht intuitiv -- möglich}.
